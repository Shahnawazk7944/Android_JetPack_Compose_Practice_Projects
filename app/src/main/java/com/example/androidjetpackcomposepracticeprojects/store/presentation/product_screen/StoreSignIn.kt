...
fun StoreSignIn(
    ...
    StoreSignInContent(authNavController = authNavController)
}

@Composable
fun StoreSignInContent(
    authNavController: NavHostController,
) {
...
//                },
            ...
            Row(
                ...
                Text(
                    ...
                    color = FPrimaryBlack,
                    textAlign = TextAlign.Center,
                    modifier = Modifier.clickable { authNavController.navigate(AuthScreen.StoreSignUp.route) }
                )
            }
        }
    }
